...
mf.level_shift = 2.0
mf.max_cycle = 200
mf.irrep_nelec = { "A1": (6, 4), 'B1': (3, 2), 'B2': (3, 2), 'A2': (1, 0) }
#mf.chkfile = 'mno.chk'
...
mf.analyze()
tools.molden.from_mo(mol, 'mno.molden', mf.mo_coeff)
...
mc.fcisolver.scratchDirectory = "/rc_scratch/anma2640/mno/"
mc.mc1step(mo)
tools.molden.from_mo(mol, 'mno_cas.molden', mc.mo_coeff)
#exit(0)
